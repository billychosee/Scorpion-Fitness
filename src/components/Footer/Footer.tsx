...
const Footer = (): JSX.Element => {
  ...
  return (
    <Section>
      <FooterSection>
        <FooterCompanyDetails>
          <FooterLogo>SCORPION</FooterLogo>
          <FooterDescription>
            Scorpion is your new home in boutique wellness. We join the
          ...
          <FooterSectionLink>
            ...
            <FooterList>
              <FooterLink
                ...
                href='https://github.com/billychosee'
              >
                About us
              </FooterLink>
            </FooterList>
            ...
            <FooterList>
              <FooterLink href='princekadyamatimba@gmail.com'>
                Contact us
              </FooterLink>
            </FooterList>
          </FooterSectionLink>
      ...
      <FooterLine />
      <Copyright>© {year} Billy Chosee All Rights Reserved</Copyright>
